...
urlpatterns = [
    ...
    path("attendance_sheet/<int:sheet_id>/", views.view_attendancesheet, name="attendance_sheet"),
   ...
   # path("consultant-dashboard/", views.consultant_dashboard, name="consultant_dashboard"),
   # path("create-sheet/", views.create_sheet, name="create_sheet"),
    path("view_sheet/<int:sheet_id>/", views.view_sheet, name="view_sheet"),
    ...
    path("admin-dashboard/", views.admin_dashboard, name="admin_dashboard"),
    path("view_attendance/<int:sheet_id>/",views.attendance_sheet_view,name="attendance_sheet"),
    ...
    #path("sheet/attendance/<int:sheet_id>/", views.attendance_sheet_view, name="attendance_sheet_view"),
    path("sheet/student/<int:sheet_id>/", views.student_sheet_view, name="student_sheet_view"),
    path("sheet/attendance/<int:sheet_id>/", views.attendance_sheet_view, name="attendance_sheet_view"),
    path("sheet/completed/<int:sheet_id>/", views.completed_sheet_view, name="completed_sheet_view"),
    path("attendance/save/<int:sheet_id>/", views.save_attendance_data, name="save_attendance_data"),
    path("student/change-password/",views.student_change_password,name="student_change_password"),
    path("consultant/change-password/",views.consultant_change_password,name="consultant_change_password"),
